    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 992px) {
            ...
            .reports-grid { grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); }
...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li><a href="AdminController?acc=reportes" class="active" ><i class="bi bi-graph-up"></i> Reportes</a></li>
            ...
            <section id="reportes" class="admin-section">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value" id="ingresosMensuales">0</div>
                        <div class="stat-label">Ingresos Mensuales</div>
                    </div>
                </div>
                
                <h3 class="section-title" style="margin-top: 40px;">Generar Reportes</h3>
                
                <div class="reports-grid">
                    <div class="report-card" onclick="generarReporteVentas()">
                        <div class="report-icon"><i class="bi bi-cart-check"></i></div>
                        <h3 class="report-title">Reporte de Ventas</h3>
                        <p class="report-description">Genera un reporte detallado de todas las ventas realizadas en un período específico.</p>
                        <button class="report-btn">
                            <i class="bi bi-download"></i> Generar Reporte
                        </button>
                    </div>
                    
                    <div class="report-card" onclick="generarReporteInventario()">
                        <div class="report-icon"><i class="bi bi-boxes"></i></div>
                        <h3 class="report-title">Reporte de Inventario</h3>
                        <p class="report-description">Obtén información actualizada sobre el estado del inventario y productos con stock bajo.</p>
                        <button class="report-btn">
                            <i class="bi bi-download"></i> Generar Reporte
                        </button>
                    </div>
                    ...
                    <div class="report-card" onclick="generarReporteClientes()">
                        ...
                        <p class="report-description">Analiza el comportamiento de los clientes y su historial de compras.</p>
                        <button class="report-btn">
                            <i class="bi bi-download"></i> Generar Reporte
                        </button>
                    </div>
                    
                    <div class="report-card" onclick="generarReporteFinanciero()">
                        <div class="report-icon"><i class="bi bi-graph-up"></i></div>
                        <h3 class="report-title">Reporte Financiero</h3>
                        <p class="report-description">Consulta el estado financiero, ingresos, gastos y proyecciones.</p>
                        <button class="report-btn">
                            <i class="bi bi-download"></i> Generar Reporte
                        </button>
                    </div>
                    
                    <div class="report-card" onclick="generarReporteProveedores()">
                        <div class="report-icon"><i class="bi bi-truck"></i></div>
                        <h3 class="report-title">Reporte de Proveedores</h3>
                        <p class="report-description">Evalúa el desempeño y relación con tus proveedores.</p>
                        <button class="report-btn">
                            <i class="bi bi-download"></i> Generar Reporte
                        </button>
                    </div>
                    
                    <div class="report-card" onclick="generarReportePersonalizado()">
                        <div class="report-icon"><i class="bi bi-gear"></i></div>
                        <h3 class="report-title">Reporte Personalizado</h3>
                        <p class="report-description">Crea un reporte específico según tus necesidades particulares.</p>
                        <button class="report-btn">
                            <i class="bi bi-download"></i> Generar Reporte
                        </button>
                    </div>
                ...
                <div class="card-admin">
                    ...
                    <p>Aquí puedes acceder a los reportes generados recientemente y gestionar el historial de reportes.</p>
                    <p><strong>Nota:</strong> Esta sección está lista para que implementes tu sistema de reportes.</p>
                </div>
            </section>
        </div>
    </div>
 ...
 <script>
        ...
        function actualizarEstadisticasReportes() {
            ...
            const ventasTotales = 12540;
            const nuevosClientes = usuarios.filter(u => u.rol === 'cliente').length;
            const productosVendidos = 892;
            const ingresosMensuales = 8560;
            ...
            document.getElementById('productosVendidos').textContent = productosVendidos.toLocaleString();
        ...
        function generarReporteClientes() {
            ...
            // Aquí iría la lógica para generar el reporte de clientes
        }

        function generarReporteFinanciero() {
            alert('Generando reporte financiero...');
            // Aquí iría la lógica para generar el reporte financiero
        }

        function generarReporteProveedores() {
            alert('Generando reporte de proveedores...');
            // Aquí iría la lógica para generar el reporte de proveedores
        }

        function generarReportePersonalizado() {
            alert('Abriendo opciones para reporte personalizado...');
            // Aquí iría la lógica para generar reportes personalizados
        }
