    ...
    <div class="admin-container">
        ...
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li><a href="AdminController?acc=productos" class="active" ><i class="bi bi-box"></i> Productos</a></li>
            ...
            <section id="productos" class="admin-section">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" id="totalProductos">${nroProductos}</div>
                        <div class="stat-label">Total Productos</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon"><i class="bi bi-check-circle"></i></div>
                        <div class="stat-value" id="productosActivos">${nroActivos}</div>
                        <div class="stat-label">Productos Activos</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon"><i class="bi bi-exclamation-triangle"></i></div>
                        <div class="stat-value" id="stockBajo">${nroStockBajo}</div>
                ...
                <div class="card-admin">
                    <div class="card-header">
                        ...
                        <button class="btn-admin" onclick="mostrarModalAgregarProducto()">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${not empty producto.imagen}">
                                                            <img src="data:image/jpeg;base64,${producto.imagenBase64}" alt="${producto.nombreProducto}" class="producto-imagen">
                                                        </c:when>
                                                        <c:otherwise>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${producto.stock <= 5}">
                                                            <span class="stock-critico">${producto.stock}</span>
                                                        </c:when>
                                                        <c:when test="${producto.stock <= 15}">
                                                ...
                                                <td>
                                                    <div class="table-actions">
                                                        <button class="btn-admin btn-table" onclick="editarProducto(${producto.idProducto})">
                                                            <i class="bi bi-pencil"></i> Editar
                                                        </button>
                                                        <button class="btn-admin btn-warning btn-table" onclick="actualizarStock(${producto.idProducto})">
                                                            <i class="bi bi-arrow-repeat"></i> Stock
                                                        </button>
                                                        <button class="btn-admin btn-danger btn-table" onclick="eliminarProducto(${producto.idProducto})">
                                    ...
                                    <c:otherwise>
                                        <tr>
                                            <td colspan="8" style="text-align: center; padding: 30px;">
                                                ...
                                                <p style="margin-top: 15px; color: var(--text-muted);">No hay productos registrados</p>
                                            </td>
                                        </tr>
                                    </c:otherwise>
                                </c:choose>
...
<div class="modal-confirm" id="modalAgregarProducto">
    <div class="modal-confirm-content">
        <div class="modal-confirm-header">
            <h3 class="modal-confirm-title"><i class="bi bi-plus-circle"></i> Agregar Producto</h3>
        </div>
        <div class="modal-confirm-body">
            <div class="alert alert-info">
                <i class="bi bi-info-circle"></i> Complete todos los campos obligatorios (*) para agregar un nuevo producto.
            </div>
            
            <form id="formAgregarProducto" action="AccionesPServlet" method="post" enctype="multipart/form-data">
                <input type="hidden" name="accion" value="agregar">
                
                <div class="form-group">
                    <label for="nombre_producto" class="form-label required">Nombre del Producto</label>
                    <input type="text" class="form-control" id="nombre_producto" name="nombre_producto" maxlength="100" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="id_categoria" name="id_categoria" required>
                        ...
                        <% 
                            // Obtener la lista de categorías del request
                            java.util.List<Categoria> listaCategorias = (java.util.List<Categoria>) request.getAttribute("listaCategorias");
                ...
                <div class="alert alert-warning">
                    <i class="bi bi-exclamation-triangle"></i> Los campos marcados con (*) son obligatorios.
                </div>
            </form>
        </div>
       <div class="modal-confirm-footer">
            <button class="btn-admin btn-cancel" onclick="cerrarModalAgregarProducto()">
                <i class="bi bi-x-circle"></i> Cancelar
            </button>
            <input type="submit" class="btn-admin" form="formAgregarProducto" name="acc" value="Insertar Producto"/>
        </div>
    </div>
</div>
...
<!--Modal para editar -->
    ...
    <script>
        ...
        function actualizarEstadisticasProductos() {
            ...
            // Asumimos que todos los productos están activos para este ejemplo
            const productosActivos = totalProductos;

            document.getElementById('nroProductos').textContent = totalProductos;
            document.getElementById('nroActivos').textContent = productosActivos;
            document.getElementById('nroStockBajo').textContent = productosStockBajo;
            document.getElementById('nroCategorias').textContent = totalCategorias;
        }
        ...
        function editarProducto(idProducto) {
            ...
            let confir = confirm("Desea editar el producto" + idProducto);
            if(confir){
                window.location.href= "AccionesPServlet?acc=editar&id="+idProducto;
            }
        }

        function actualizarStock(idProducto) {
            alert('Actualizar stock del producto con ID: ' + idProducto);
        ...
        function eliminarProducto(idProducto) {
            ...
            if (confirmacion) {
                ...
                window.location.href = "AccionesPServlet?acc=eliminar&id=" + idProducto;
            }
        }
    </script>
</body>
