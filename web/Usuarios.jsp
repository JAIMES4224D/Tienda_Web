...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* --- MEJORAS VISUALES TABLA USUARIOS (By Dudu) --- */
...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li><a href="AdminController?acc=usuarios" class="active" ><i class="bi bi-people"></i> Gestionar Usuarios</a></li>
        ...
        <%
            ...
            int administradores = (Integer) request.getAttribute("administradores");
            int clientes = (Integer) request.getAttribute("clientes");
            ...
            <section id="usuarios" class="admin-section">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" id="statTotalUsuarios">
                            ${not empty totalUsuarios ? totalUsuarios : '0'}
                        </div>
                        <div class="stat-label">Total Usuarios</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon"><i class="bi bi-person-check"></i></div>
                        <div class="stat-value" id="usuariosActivos"><%=totalUsuarios%></div>
                        <div class="stat-label">Usuarios Activos</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon"><i class="bi bi-person-gear"></i></div>
                        <div class="stat-value" id="totalAdministradores"><%=administradores%></div>
                        <div class="stat-label">Administradores</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon"><i class="bi bi-person-gear"></i></div>
                        <div class="stat-value" id="totalAdministradores"><%=clientes%></div>
                ...
                <div class="card-admin">
                    <div class="card-header">
                        ...
                        <button class="btn-admin" onclick="mostrarModalAgregarUsuario()">
    ...
    <div class="modal-confirm" id="modalAgregarUsuario">
    <div class="modal-confirm-content">
        <div class="modal-confirm-header">
        ...
        <div class="modal-confirm-body">
            <form id="formAgregarUsuario" action="AccionesPServlet" method="post" enctype="multipart/form-data">
                <input type="hidden" name="acc" value="insertar_usuario">
                ...
                <div style="text-align: left; display: grid; gap: 15px;">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            ...
                            <input type="file" class="form-control" name="foto" accept="image/*" onchange="vistaPreviaFoto(this, 'preview_new')">
                        </div>
                    </div>

                    <div class="text-center mt-2" id="preview_container_new" style="display:none;">
                        <p style="font-size: 0.8rem; color: var(--text-muted); margin-bottom: 5px;">Vista previa:</p>
                        <img id="preview_new" src="#" alt="Vista Previa" 
                             style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%; border: 2px solid var(--primary-color);">
                    </div>
                </div>
            </form>
        </div>
        <div class="modal-confirm-footer">
            <button class="btn-admin" onclick="cerrarModalAgregarUsuario()">
                <i class="bi bi-x-circle"></i> Cancelar
            </button>
            <button type="submit" form="formAgregarUsuario" class="btn-admin btn-success">
 ...
 <script>
        ...
        function actualizarEstadisticasUsuarios() {
            const totalUsuarios = usuarios.length + administradores.length;
            const usuariosActivos = totalUsuarios; // Asumimos que todos están activos
            const totalAdministradores = administradores.length;
            
            // Simular nuevos usuarios hoy
            const nuevosUsuarios = 3;
            
            document.getElementById('totalUsuarios').textContent = totalUsuarios;
            document.getElementById('totalUsuarios').textContent = usuariosActivos;
            document.getElementById('administradores').textContent = totalAdministradores;
            document.getElementById('clientes').textContent = nuevosUsuarios;
        }
        // =============================================
        // FUNCIONES PARA EDITAR INSERTAR ELIMINAR
        // =============================================
        // --- Lógica para Modal AGREGAR ---
        function mostrarModalAgregarUsuario() {
            document.getElementById('modalAgregarUsuario').classList.add('active');
        }

        function cerrarModalAgregarUsuario() {
            document.getElementById('modalAgregarUsuario').classList.remove('active');
            document.getElementById('formAgregarUsuario').reset(); // Limpia el form
        }
